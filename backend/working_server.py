...
async def get_agents():
    ...
    for a in orchestrator.agents.values():
        result.append({
            ...
            "revival_count": a.revival_count if hasattr(a, 'revival_count') else 0,
            "spouse_id": a.spouse_id if hasattr(a, 'spouse_id') else None,
            "relationship_status": a.relationship_status if hasattr(a, 'relationship_status') else "single",
            "children": a.children if hasattr(a, 'children') else [],
            "home_location": list(a.home_location) if hasattr(a, 'home_location') and a.home_location else None,
